...
![Proved fixtures](https://img.shields.io/badge/proved_fixtures-268-brightgreen)
...
268 fixtures with 4 explicit exclusions and 0 uncovered fixtures: 3 frontend
...
| Metric | Value |
|--------|-------|
| Proved emitted fixtures | 268 (4 exclusions: 3 spec, 1 tooling, 0 runtime proof gaps; 0 uncovered) |
...
| Test corpus | 657 `.safe` files (positive, negative, build, concurrency, interfaces, embedded, emitted-shape) |
