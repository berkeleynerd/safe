...
![Proved fixtures](https://img.shields.io/badge/proved_fixtures-260-brightgreen)
...
260 fixtures with 4 explicit exclusions and 0 uncovered fixtures: 3 frontend
...
| Metric | Value |
|--------|-------|
| Proved emitted fixtures | 260 (4 exclusions: 3 spec, 1 tooling, 0 runtime proof gaps; 0 uncovered) |
...
| Test corpus | 647 `.safe` files (positive, negative, build, concurrency, interfaces, embedded, emitted-shape) |
