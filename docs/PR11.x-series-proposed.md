...
for statically field-disjoint actuals.

### Scope

- Extend call-site alias analysis from root-object equality to normalized field
  access paths.
- Continue rejecting overlapping paths and any case that cannot be proven
  disjoint statically.
...
Follows PR11.8g.3. Must land before PR11.9 so that the artifact contract freeze
