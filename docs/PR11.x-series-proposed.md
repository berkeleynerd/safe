...
Dependency chain: PR10.1 → PR10.3 / PR10.4 / PR10.5, with PR10.6 depending on
PR10.3, PR11.1 depending on PR10.4, PR10.5, and PR10.6, PR11.3a following
PR11.3, PR11.8a following PR11.8, and PR11.8b running as a parallel track
after PR10.5 and PR10.6 that must land before PR11.9.
...
- Parser support for the new spellings, with a clear coexistence or migration
  rule for legacy forms.
- Mechanical migration strategy for the existing test corpus and Rosetta corpus.
- Deterministic acceptance corpus showing that the feature is surface-only and
  does not perturb typing, MIR, or emission for already-supported programs.
...
- Explicit admission criteria for reference-surface syntax, including parser,
  readability, ownership-model, and tooling consequences.
...
| Emitter-Based Container Instantiation | PR11.11 |
