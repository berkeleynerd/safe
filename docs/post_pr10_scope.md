...
| `PS-035` | Broader `select ... or delay ...` fairness and latency semantics beyond the admitted fair round-robin dispatcher contract shipped after `PR11.9b` | `docs/jorvik_concurrency_contract.md`; `spec/04-tasks-and-channels.md` section `4.4` | `spec` | `long-term` |
