...
class ValidateExecutionStateTests(unittest.TestCase):
    ...
    def test_pr111_glue_scripts_are_registered_for_safety_audit(self) -> None:
        ...
        self.assertIn("scripts/run_pr115_statement_ergonomics.py", GLUE_SAFETY_AUDITED_SCRIPTS)
        self.assertIn("scripts/run_pr115_statement_ergonomics.py", GLUE_SAFETY_REPORT_SCRIPTS)
        self.assertIn("scripts/run_pr115_statement_ergonomics.py", GLUE_SAFETY_ALLOWED_SAFE_SOURCE_READERS)
