...
SELECTED_EMITTED_CORPUS: list[dict[str, Any]] = [
    {
        ...
        "source_fragments": [
            "function average (data : readings) returns reading",
    ...
    },
    {
        ...
        "source_fragments": [
            "function summarize_prefix (Head : node_ptr) returns total_value",
            "count = count + 1",
            "total = total + total_value (Head.value)",
            "var Second : access constant node = Head.Next.access",
            "total = total + total_value (Second.value)",
        ],
    },
    {
        ...
        "source_fragments": [
            ...
            "function normalize_x (input : vector3) returns float",
            "if input.x > 0.0",
            "if input.y > 0.0",
            "if input.z > 0.0",
